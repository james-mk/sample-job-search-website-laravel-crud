            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                          <li class="nav-item">
                            <a class="nav-link" href="tel:0722123456">Call Support: 0722123456</a>
                        </li>
                          <li class="nav-item">
                            <a class="nav-link" href="mailto:jobhunter@website.com">Email Support: jobhunter@website.com</a>
                        </li>
                         <!-- <li class="nav-item">
